...
public abstract class BasicMessageHandler implements IMessageHandler {
    ...
    protected WorkingThread workingRunnable = new WorkingThread(this);
    protected Thread workingThread = new Thread(workingRunnable);
    ...
    protected class WorkingThread implements Runnable {
        ...
        private LinkedList<String> toProccess = new LinkedList<String>();
